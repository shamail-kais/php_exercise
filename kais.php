...
<body>
    <div class="container">
        ...
        <br>
        <?php
        if(!empty($_GET) && $_GET['message'] == "fail"){   
        ?>
            ...
            <div class="form-group">
                <div class="row justify-content-md-center">
                    ...
                    <div class="col col-sm-3">
                        <input class="form-control" name="user_name" type="email" id="user_name">
                    </div>
                </div>
                <br>
                <div class="row justify-content-md-center">
                    ...
                    <div class="col col-sm-3">
                        <input class="col col-sm-3 form-control" name="password" type="password" id="password">
                    </div>
                </div>
                <div class="row justify-content-md-center">
